...
IF(WIN32)
	if(MSVC)
		...
		if(MSVC_VER VERSION_GREATER_EQUAL 19.51)
			set(LMMS_MSVC_GENERATOR "Visual Studio 18 2026")
			set(LMMS_MSVC_YEAR 2026)
		else()
			message(FATAL_ERROR "Unsupported MSVC version '${MSVC_VER}'. MSVC 19.51 or higher is required.")
		endif()
